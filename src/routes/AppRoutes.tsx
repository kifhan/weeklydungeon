  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="practice" element={uid ? <PracticePage uid={uid} /> : <Navigate to="/login" replace />} />
        <Route path="history" element={uid ? <HistoryPage uid={uid} /> : <Navigate to="/login" replace />} />
